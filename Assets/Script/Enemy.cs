...
namespace Script
{
    public class Enemy : MonoBehaviour
    {
        ...
        [SerializeField] private int indexBase = 1;
        [SerializeField] private int indexTowel = 1;
        [SerializeField] private int indexFast = 1;
        [SerializeField] private int indexPowerd = 1;
       ...
       [SerializeField] public int GamePlayer;

        private float timeBullet;
        [SerializeField] private float starttimeBullet;
        [SerializeField] private bool die1 = true;
        [SerializeField] private int directs = 4;
        ...
        public Text DieNumber { get; internal set; }
        ...
        void Start()
        {
         ...
         //   dir = 1;
            ...
            ModelPowerd();
            ModelTowel();
            //NumberPlayer.text = $"{GamePlayer-2}";
        ...
        void Update()
        {
            ...
            if (Die1)
            {
                ...
                if (timeBullet <= 0)
                {
                    ...
                    GameObject bullet;
                    bullet = Instantiate(bullet_obj, transform.position, Quaternion.identity);
        ...
        {
          //  dil = GamePlayer - 2;
            baseEnemy.Gamer(GamePlayer,Point);
            _boxColleder.isTrigger = true;
            gameObject.layer = 16;
        ...
        void Model()
        {
            ...
            if (Models == 1)
            {
                ...
                //else if (hit2DP.collider.CompareTag("Enemy"))
                //{
            ...
            if (Models == 2)
            {
                ...
                if (hit2DP.collider != null)
                {
                    ...
                    if (hit2DP.collider.CompareTag("Player"))
                    {
                        if (hit2DP.collider.GetComponent<PlayerController>().ButtleM == true)
                        {
                            if (IndexTowel >= hit2DP.collider.GetComponent<PlayerController>().IndexTowel && IndexTowel == 3)
                            {
                    ...
                    if (hit2DP.collider.CompareTag("PlayerFriends"))
                    {
                        if (IndexTowel >= hit2DP.collider.GetComponent<PlayerFriendsConroller>().IndexTowel && IndexTowel == 3)
                        {
            ...
            if (Models == 3)
            {
                ...
                if (hit2DP.collider != null)
                {
                    ...
                    if (hit2DP.collider.CompareTag("Player"))
                    {
                        if (hit2DP.collider.GetComponent<PlayerController>().ButtleM == true)
                        {
                            if (IndexPowerd >= hit2DP.collider.GetComponent<PlayerController>().IndexPowerd && IndexPowerd == 3)
                            {
                    ...
                    if (hit2DP.collider.CompareTag("PlayerFriends"))
                    {
                        if (IndexPowerd >= hit2DP.collider.GetComponent<PlayerFriendsConroller>().IndexPowerd && IndexPowerd == 3)
                        {
            ...
            if (Models == 4)
            {
                ...
                if (hit2DP.collider != null)
                {
                        ...
                        if (hit2DP.collider.CompareTag("Player"))
                    {
                        if (hit2DP.collider.GetComponent<PlayerController>().ButtleM == true)
                        {
                            if (IndexFast >= hit2DP.collider.GetComponent<PlayerController>().IndexFast && IndexFast == 3)
                            {
                     ...
                     if (hit2DP.collider.CompareTag("PlayerFriends"))
                    {
                        if (IndexFast >= hit2DP.collider.GetComponent<PlayerFriendsConroller>().IndexFast && IndexFast == 3)
                        {
